...
SECRET_KEY = 'django-insecure-cgwrr*firwv1!=-__=7c+grti)c)^=wucdofqu*y=-+liiynq-'
...
HUGGINGFACE_API_TOKEN = os.getenv('HF_TOKEN', None)
...
# Hugging Face Configuration (Optional - for better rate limits)
